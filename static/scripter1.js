...
//...........................................Product OEE (later)........................................................//
// Function to check the system connection status (Online/Offline)
...
// Function to check the system state (ON/OFF)
function checkSystemState() {
    ...
    .then(data => {
        if (data.error) {
            console.error("PLC connection failed");
            systemStateControl.innerText = "OFF";
            systemStateControl.style.color = "red";
            return;
        }

        if (data.Y0 === 1) {
            systemStateControl.innerText = "ON";
            systemStateControl.style.color = "green";
        } else {
            systemStateControl.innerText = "OFF";
            systemStateControl.style.color = "red";
        }
...
// You can call these functions when the page loads or based on some event
document.addEventListener("DOMContentLoaded", function() {
    checkSystemStatus();  // Check connection status
    checkSystemState();   // Check system state (Y0)
});
...
function TurnOnSystem() {
    ...
    .then(data => {
        console.log(data);
        checkSystemState();  // Run status check
    })
    .catch(error => {
